...
STAGE2 = [
    {
        ...
        "panel": "demand",
        "segments": [("采购成本保障岗", 2, 31, None)],
        "outputs": ["物资需求测算表", "9网格采购需求单"],
    },
    {
        "key": "s2-t2",
        "no": 2,
    ...
    },
    {
        ...
        "panel": "supplier",
        "segments": [
            ("采购成本保障岗", 70, 85, "综合评分与初始排序"),
            ("应急预算绩效岗", 2, 6, "预算与网格保障复核"),
            ("资金核算风控岗", 2, 6, "供应商主体资质核验"),
            ("财务主管统筹岗", 2, 7, "主备供应商定位审批"),
        ],
    ...
    },
    {
        ...
        "panel": "contract",
        "segments": [
            ("采购成本保障岗", 88, 108, "合同金额与控制条款"),
            ("应急预算绩效岗", 8, 12, "预算占用率测算"),
            ("资金核算风控岗", 8, 17, "金额核对与台账建立"),
            ("财务主管统筹岗", 9, 13, "初始合同与直采方案审批"),
        ],
        "outputs": ["HT-2025-001采购合同", "初始预算占用表", "采购资金台账"],
    },
    {
        "key": "s2-t5",
        "no": 5,
        ...
        "panel": "split",
        "intro": ("采购成本保障岗", 110, 111),
        "steps2": [
            ("procurement", "采购成本保障岗", 113, 114, None),
            ("procurement", "采购成本保障岗", 116, 119, None),
            ("budget-performance", "应急预算绩效岗", 15, 17, None),
            ("budget-performance", "应急预算绩效岗", 18, 24, None),
            ("fund-risk", "资金核算风控岗", 20, 24, None),
            ("procurement", "采购成本保障岗", 122, 127, None),
            ("procurement", "采购成本保障岗", 129, 132, None),
            ("procurement", "采购成本保障岗", 134, 138, None),
            ("procurement", "采购成本保障岗", 140, 150, None),
            ("budget-performance", "应急预算绩效岗", 27, 33, None),
            ("finance-lead", "财务主管统筹岗", 16, 22, ("决策", "审核三种处置路径并批准组合方案")),
            ("procurement", "采购成本保障岗", 153, 156, None),
            ("procurement", "采购成本保障岗", 157, 162, None),
            ("budget-performance", "应急预算绩效岗", 36, 46, None),
            ("fund-risk", "资金核算风控岗", 27, 30, None),
            ("fund-risk", "资金核算风控岗", 31, 34, None),
            ("procurement", "采购成本保障岗", 165, 169, None, "网格物资调度专员"),
        ],
        "outputRows": ("财务主管统筹岗", 24, 24),
        "outputs": [],
    },
    {
        "key": "s2-t6",
        ...
        "panel": "handover",
        "segments": [
            ("采购成本保障岗", 172, 175, "变更后合同复核"),
            ("应急预算绩效岗", 48, 50, "预备费阶段性结余确认"),
            ("资金核算风控岗", 36, 37, "合同与直采映射确认"),
            ("财务主管统筹岗", 29, 30, "变更后合同控制审核"),
        ],
        "outputs": ["变更后采购执行汇总表", "第二阶段移交清单"],
    },
]
